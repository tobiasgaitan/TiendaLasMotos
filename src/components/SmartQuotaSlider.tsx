            ...
            <div className="p-6 space-y-6">
                ...
                <div className="bg-slate-100 p-1 rounded-xl flex relative">
                    <button
                        ...
                        className={`flex-1 py-3 rounded-lg text-sm font-bold uppercase transition-all z-10 ${isCredit ? 'bg-white shadow-md text-brand-blue' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        Financiación
                    </button>
                    <button
                        onClick={() => setSaleMode('cash')}
                        className={`flex-1 py-3 rounded-lg text-sm font-bold uppercase transition-all z-10 ${!isCredit ? 'bg-white shadow-md text-green-700' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        De Contado
                    </button>
                </div>
