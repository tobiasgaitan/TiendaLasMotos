    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <button
                    onClick={closeModal}
                    className="fixed top-4 right-4 z-[9999] bg-red-600 text-white p-3 rounded-full hover:bg-red-700 transition-all shadow-2xl border-2 border-white cursor-pointer"
